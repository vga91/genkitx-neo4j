...
// import { gemini15Pro, googleAI, textEmbeddingGecko001 } from "@genkit-ai/googleai";
// import { firestorePlugin, defineFirestoreRetriever } from "@genkit-ai/firebase";
...
// const ai = genkit({
//   plugins: [googleAI(),
//         firestorePlugin({ firestore }) // il plugin riceve l’istanza
...
//   // 1️⃣ Crea embedding (array → prendo il primo)
...
//   // 2️⃣ Salva in Firestore (vector store)
//   await firestore.collection("documentsCollection").doc(docId).set({
//     text,
//     embedding,
//   });

//   // 3. Estrazione entità/relazioni (semplice via LLM)
...
// const vectorRetriever = defineFirestoreRetriever(
//   firestore, // 1° argomento: istanza Firestore
//   {
...
//     model: ai.models.gemini15ProLatest,
//     prompt: `
